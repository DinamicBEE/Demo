...
export const menuItems = [
  ...
  { name: 'Corte de caja', path: '/homeV2', icon:<PiCashRegisterLight />, roles: [ROLES.ADMIN, ROLES.SUPERVISOR_CDC, ROLES.GENERAL_ZONE, ROLES.REVENUE_MANAGER, ROLES.COMPTROLLER] },
  { name: 'Cierre de lotes', path: '/lotClosure', icon:<LuContainer />, roles: [ROLES.ADMIN, ROLES.SUPERVISOR_CDC, ROLES.GENERAL_ZONE, ROLES.REVENUE_MANAGER, ROLES.COMPTROLLER] },
  ...
  { name: 'Reportes', path: '/reports', icon:<VscGraph />, roles: [ROLES.ADMIN, ROLES.SUPERVISOR_CDC, ROLES.GENERAL_ZONE, ROLES.REVENUE_MANAGER, ROLES.COMPTROLLER] },

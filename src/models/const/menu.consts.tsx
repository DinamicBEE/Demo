...
export const ROLES_APPROVALS = [ROLES.ADMIN, ROLES.CONTROLLER, ROLES.REVENUE_MANAGER];
...
export const menuItems = [
  ...
  { name: 'Aprobación de solicitud', path: '/approvals', icon:<LuClipboardList />, roles: [ROLES.ADMIN, ROLES.CONTROLLER, ROLES.REVENUE_MANAGER] },

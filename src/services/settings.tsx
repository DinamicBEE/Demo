...
export const API_LOCAL = 'https://18.216.99.233:8085/'; //'https://localhost:8085';
...
export const GET_CLOUSINGS = 'https://18.216.99.233:8085/crc/cash-register-closure/api/registerclosure/search';
//Cierrre de Lote

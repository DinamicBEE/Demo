...
const CRC_BASE = `/cash-register-closure`;
...
export const GET_BATCH_V2 = `${BATCH_BASE}/getBatchClosurev2`;
export const GET_BATCH_DETAILS_V2 = `${BATCH_BASE}/getBatchClosureDetailv2`;
...
export const GET_STATUS_BATCH = `${API_BASE}/summary/statusBatch`;

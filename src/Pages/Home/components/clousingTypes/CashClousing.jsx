  ...
  return (
    <Box>
      <Grid templateColumns={{ base: "1fr", md: "repeat(4, 1fr)" }} gap={4} mb={4}>
        ...
        <EditableCurrencyInput name={"Propina de fondo"} value={cashData.tips} loading={cashLoading}
            ...
            {cashData?.currencies?.map((item) => (
              <Table.Row key={item.id}>
                ...
                <Table.Cell>
                  {
                    data != null &&
                    <TableInput value={item.totalFisico} id={item.id} currency={true} onChange={handleInputChange} disabled={data.closingConfirmation} />
                  }
                </Table.Cell>
